...
import SlideWrapper from './(pages)/components/slide/SlideWrapper';
...
const generateMockAccounts = (start: number): IAccount[] =>
  Array.from({ length: 8 }).map((_, idx) => ({
    ...
    rating: 5,
    imageUrl:
      idx % 3 === 0 ? '/img/others/img-12.jpg' : '/img/others/img-14.jpg',
...
const LandingCard = ({ card }: { card: IAccount }) => (
...
export default function HomePage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      accent: 'var(--landing-green)',
      cards:
        deltaForceAccounts.length > 0
          ? deltaForceAccounts
          : generateMockAccounts(20),
    },
  ];
            ...
            <div className="cta-row">
              ...
              <Link href="#account-delta">
                <button
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #1faa63 0%, #26f0a4 100%)',
                  }}
                >
                  ACC Delta Force
                </button>
          ...
          {heroCards.map((item) => (
            ...
            >
              <div className="content">
                ...
                <h4>{item.title}</h4>
                <span style={{ color: item.accent, fontWeight: 700 }}>
                  Xem ngay →
                </span>
              </div>
          ...
          {faqs.map((faq) => (
            <div key={faq.title} className="landing-faq-card">
              ...
              <div className="landing-faq-body">
                ...
                <div style={{ color: 'var(--landing-muted)', fontSize: 12 }}>
                  {faq.date}
                </div>
              </div>
            </div>
      ...
      <footer id="about" className="landing-footer">
        <div className="landing-footer-grid">
          <div>
            ...
            />
            <p>
              Chúng tôi đặt sự uy tín làm trọng tâm. Mỗi tài khoản đều được kiểm
              tra kỹ lưỡng và mô tả minh bạch.
            </p>
          </div>
          <div>
